...
def load_puzzle_data() -> List[List[int]]:
    ...
    try:
        with open("data.txt") as f:
            ...
            print(Style.DIM + "[+] Loaded puzzle data" + Style.NORMAL)
            return [
...
def main() -> None:
    ...
    print(
        ...
        + Back.LIGHTBLACK_EX
        + Fore.WHITE
        + f"[+] The biggest mule elf is carrying {max_calories} calories"
        + Style.RESET_ALL
    )
    # --- Part 2 ---
    ...
    print(
        ...
        + Back.LIGHTBLACK_EX
        + Fore.WHITE
        + f"[+] The top three mule elves are carrying {top_3_most_calories} calories"
        + Style.RESET_ALL
    )
...
if __name__ == "__main__":
    ...
    print(Style.DIM + f"[+] Completed in {elapsed_time:.4f} seconds" + Style.RESET_ALL)
